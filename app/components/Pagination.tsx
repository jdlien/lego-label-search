  ...
  return (
    <nav className={`flex items-center justify-center space-x-1 ${className}`} aria-label="Pagination">
      ...
      <button
        ...
        disabled={!hasPrev}
        className={`flex items-center justify-center rounded-md px-1 py-1 text-sm font-medium ${
          hasPrev
        ...
        {pageNumbers.map((page, index) => {
          if (page === '...') {
            return (
              <span
                key={`ellipsis-${index}`}
                className="px-1 py-1 text-sm font-medium text-gray-500 dark:text-gray-400"
              >
                ...
              </span>
            )
          ...
          return (
            <button
              ...
              className={`min-w-8 rounded-md px-1 py-1 text-sm font-medium ${
                isCurrentPage
