...
const IconMapMarker = ({ className = 'aspect-square' }: { className?: string }) => (
  <svg className={className} viewBox="0 0 384 512" width="20" height="20">
    <path
      fill="currentColor"
...
const IconLink = ({ className = 'aspect-square' }: { className?: string }) => (
  <svg className={className} viewBox="0 0 640 512" width="20" height="20">
    <path
      fill="currentColor"
...
const IconCalendar = ({ className = 'aspect-square' }: { className?: string }) => (
  <svg className={className} viewBox="0 0 448 512" width="20" height="20">
    <path
      fill="currentColor"
...
const IconCurrencyDollar = ({ className = 'aspect-square' }: { className?: string }) => (
  <svg className={className} viewBox="0 0 320 512" width="20" height="20">
    <path
      fill="currentColor"
