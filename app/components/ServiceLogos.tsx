...
export default function ServiceLogo({ serviceName, className }: ServiceLogoProps) {
  switch (serviceName) {
    case 'LEGO Pick a Brick':
      return <LegoLogo className={className} />
    case 'Rebrickable':
      return <RebrickableLogo className={className} />
    case 'Bricklink':
      return <BricklinkLogo className={className} />
    case 'Brickset':
      return <BricksetLogo className={className} />
    case 'LDraw':
      return <LDrawLogo className={className} />
    default:
      return <PlaceholderLogo color="#95A5A6" className={className} />
  }
}
